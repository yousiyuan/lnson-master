package com.lnson.simple.projname.web.test;
...
public class EbBrandServiceTest {
	...
	public void deleteObjectTest() {
		ebBrandService.deleteObject(3082L);
	}
	...
	public void updateObjectTest() {
		EbBrand entity = new EbBrand();
		entity.setBrandId(3081L);
		entity.setBrandName("未来人类");
		entity.setBrandDesc("笔记本电脑");
		entity.setImgs("这是图片");
		entity.setWebsite("京东");
